...
return [
    ...
    */
    ...
    'digits'               => ':digits桁までの数字で入力してください',
    'digits_between'       => ':桁までの数字で入力してください',
    ...
    */
    ...
    'custom' => [
        ...
        'now_weight' => [
            ...
            '[0-9]{,4}' => '4桁までの数字で入力してください',
            'decimal:4,1' => '小数点は1桁で入力してください'
        ],
        'target_weight' => [
            'required' => '目標の体重を入力してください',
            'numeric' => '4桁までの数字で入力してください',
            'decimal:4,1' => '小数点は1桁で入力してください'
        ]
    ],
